...
namespace WindowsFormsApp1
{
    public partial class user3 : Form
    {
        ...
        public void Table()
        {
            ...
            Dao dao = new Dao();
            string sql = $"select [no],[bid],[datetime] from t_lend1 where [uid]='{Data.UID}'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"delete from t_lend1 where [no]={no};update t_book set number = number+1 where id = '{id}'";
            Dao dao = new Dao();
